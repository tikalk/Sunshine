...
import com.tikalk.sunshine.sunshine.data.db.WeatherDbHelper;
    ...
    */
    public void testLocationTable() {
        ...
        try {
            ...
            cursor = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, null, null, null, null, null);
            ...
            // query if you like)
            TestUtilities.validateCurrentRecord(" Not north Pool", cursor, TestUtilities.createNorthPoleLocationValues());
        } finally {
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        // Create ContentValues of what you want to insert
        // (you can use the createNorthPoleLocationValues if you wish)
        final ContentValues northPoleLocationValues = TestUtilities.createNorthPoleLocationValues();
        // Insert ContentValues into database and get a row ID back
